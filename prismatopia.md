...
5. Start Prismatopia locally

    ```bash
    make local-up
    ```

6. Deploy the data model

    ```bash
    make local-prisma-deploy
    ```

7. Get a token for your local Prisma

    ```bash
    make local-prisma-token
    ```

8. Open the Prisma playground
    - <http://localhost:7000>

9. Open the 'HTTP Headers' setting in the GraphQL Playground and set your token, like this:
